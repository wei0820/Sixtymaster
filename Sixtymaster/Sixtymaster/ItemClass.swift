...
class itemClass {
    ...
    static func setUITextView(mUITextView : UITextView,item :Int){
        ...
        case 50:
            ...
            求得此籤表示，所祈求的事情需要歷經阻礙，而且在過程中，得籤者可能會有意志動搖想放棄的時候，所以當你要向祈求神明幫忙時，神明要你先確定自己是否有堅定的決心與毅力，如果確認自己有絕不改變決心，會堅持到持續不斷努力下去，會有好消息，而且神明會幫助你的。
            """
        case 51:
            mUITextView.text = """
            六十甲子籤
        ...
        case 60:
            ...
            運氣來的事後就像在月亮出來的時候，光輝照耀，做事順利。但是月亮的光輝也有被雲遮住的時候，在這個時候時運不濟，需要自我反省檢討、多充實自己、多做好事，這樣當機會來臨的時候，你平日的累積將會幫助你成功。

            此籤中「戶內」二字，所以欲離家外出發展者不宜。「再作福」有第一次未能成功，需要再次努力的意涵。
            """
        case 61:
            mUITextView.text = """
